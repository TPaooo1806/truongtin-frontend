...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: product.description || `Mua ${product.name} chính hãng, giá tốt tại Cửa hàng Trường Tín.`,
    openGraph: {
      title: `${product.name} - Giá tốt tại Trường Tín`,
      description: product.description || `Nhấp vào để xem chi tiết và báo giá ${product.name}.`,
      images: [
        {
          url: ogImage,
          width: 800,
  ...
  if (!product) {
    return (
      <div className="container py-5 text-center">
        <h3 className="fw-bold text-danger">Rất tiếc! Không tìm thấy vật tư này.</h3>
